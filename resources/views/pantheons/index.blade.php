                        ...
                        <tr>
                            ...
                            <td class="text-nowrap">
                                <a href="{{ route('pantheons.show', $pantheon->id) }}" class="btn btn-primary" aria-label="Visualizza pantheon {{ $pantheon->name }}">Visualizza
                                    pantheon</a>
                                <a href="{{ route('pantheons.edit', $pantheon->id) }}" class="btn btn-warning" aria-label="Modifica pantheon {{ $pantheon->name }}">Modifica</a>
                                <button type="button" data-bs-toggle="modal"
                                    data-bs-target="#confirmDeleteModal-{{ $pantheon->id }}"
                                    class="btn btn-danger" aria-label="Elimina pantheon {{ $pantheon->name }}">Elimina</button>
                            </td>
                        </tr>
