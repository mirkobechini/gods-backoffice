    ...
    public function run(): void
    {
        $gods = [
            ...
            [
                "name" => "Amaterasu",
                "title" => "Dea del Sole",
                "image" => "gods-thumb/amaterasu.png",
            ...
            [
                "name" => "Poseidone",
                "title" => "Dio del Mare",
                "image" => "gods-thumb/poseidone.png",
